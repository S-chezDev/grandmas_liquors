...
DROP FUNCTION IF EXISTS sync_cliente_from_usuario();
DROP FUNCTION IF EXISTS sync_usuario_from_cliente();
...
-- Password: password_123 (hash bcrypt)
...
('Admin', 'Sistema', 'CC', '1234567890', 'admin@grandmas.local', '3001234567', 'Oficina Central', '$2a$10$YourHashedPasswordHere', 1, 'Activo'),
('Asesor', 'Principal', 'CC', '1234567891', 'asesor@grandmas.local', '3001234568', 'Calle Principal 123', '$2a$10$YourHashedPasswordHere', 2, 'Activo'),
('Productor', 'Jefe', 'CC', '1234567892', 'productor@grandmas.local', '3001234569', 'Zona Producción', '$2a$10$YourHashedPasswordHere', 3, 'Activo'),
('Repartidor', 'Uno', 'CC', '1234567893', 'repartidor1@grandmas.local', '3001234570', 'Zona Reparto', '$2a$10$YourHashedPasswordHere', 4, 'Activo'),
('Cliente', 'Ejemplo', 'CC', '1234567894', 'cliente@gmail.com', '3001234571', 'Calle Secundaria 456', '$2a$10$YourHashedPasswordHere', 5, 'Activo');
...
(5, 'Cliente', 'Ejemplo', 'CC', '1234567894', 'cliente@gmail.com', '3001234571', 'Calle Secundaria 456', 'Activo');
